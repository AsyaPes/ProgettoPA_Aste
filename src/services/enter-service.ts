 ...
 */
export function bet ( user_id: string, auction_id: number, res: any): void {
 ...
 * @param res risposta da parte del sistema
 */
export function showNRilanci ( user_id: string, auction_id: number, res: any): void {
 ...
 * @param res risposta da parte del sistema
 */
export function betClose ( user_id: string, auction_id: number, bet: number, res: any): void {
    Enter.update({bet: bet}, {where: {fkuser_id: user_id, fkauction_id: auction_id}}).then(arr=>{
        Enter.findAll({attributes: ['bet'], where: {fkuser_id: user_id, fkauction_id: auction_id}}).then(arr1=>{
            res.json(arr);
        });
    });
};
